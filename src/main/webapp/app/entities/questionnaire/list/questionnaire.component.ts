...
export class QuestionnaireComponent implements OnInit {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.questionnaireService
      ...
      .subscribe({
        next: (res: HttpResponse<IQuestionnaire[]>) => {
  ...
  trackId(_index: number, item: IQuestionnaire): number {
    return item.id!;
  }
  ...
  protected onSuccess(data: IQuestionnaire[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
